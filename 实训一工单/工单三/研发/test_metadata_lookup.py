# -*- coding: utf-8 -*-
"""Regression checks for fixed document metadata lookups."""
...
def test_legal_representative_uses_metadata_lookup():
    engine = RAGEngine()
    ...
    assert response.query_analysis["intent"] == "metadata_lookup"


def test_spaced_chinese_question_uses_metadata_lookup():
    engine = RAGEngine()
    engine.document_metadata_by_company = {
        "武汉兴图新科电子股份有限公司": {
            "company_name": "武汉兴图新科电子股份有限公司",
...
def test_stream_legal_representative_uses_metadata_lookup():
    engine = RAGEngine()
    engine.document_metadata_by_company = {
        "武汉兴图新科电子股份有限公司": {
            "company_name": "武汉兴图新科电子股份有限公司",
...
def test_liyuan_metadata_and_table_questions():
    ...
    engine.document_metadata_by_company = {
        "武汉力源信息技术股份有限公司": {
            ...
            "registered_capital": "5,000万元",
            "total_shares": "1,670万股",
            "post_issuance_ratio": "25.04%",
            "control_related_party": "赵马克",
            "control_related_party_share": "42.35%",
            "control_related_party_relationship": "公司控股股东",
            "non_control_related_parties": "融冰投资、武汉博润、上海博润、听音投资、联众聚源、力源贸易、普芯达",
        }
    }
    engine.vector_store.create_vectorstore(
        [
