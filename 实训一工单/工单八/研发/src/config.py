...
class Config:
    ...
    # 检索策略配置（用户可调）
    RETRIEVAL_CONFIG = {
        "mode": os.getenv("RETRIEVAL_MODE", "hybrid"),  # bm25 / vector / hybrid / graph_rag / hybrid_graph
    ...
    # Graph RAG / Neo4j 配置。NEO4J_PASSWORD 为空时按本地免密 Neo4j 连接。
    ENABLE_NEO4J_GRAPH = os.getenv("ENABLE_NEO4J_GRAPH", "true").lower() == "true"
