...
class Config:
    ...
    MULTIMODAL_WORK_ORDER_IMAGES = {
        "organization_chart": {
            "path": os.getenv("ORGANIZATION_CHART_IMAGE", "parsed_output/images/招股说明书2_p039_render.png"),
            "page": int(os.getenv("ORGANIZATION_CHART_PAGE", "39")),
            "source_file": os.getenv("ORGANIZATION_CHART_SOURCE_FILE", "招股说明书2.pdf"),
            "title": "组织结构图",
        },
        "ic_market_growth": {
            "path": os.getenv("IC_MARKET_GROWTH_IMAGE", "parsed_output/images/招股说明书2_p072_render.png"),
