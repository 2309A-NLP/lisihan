...
class Config:
    ...
    PDF_PARSER_BACKEND = os.getenv("PDF_PARSER_BACKEND", "local").lower()
    ...
    MINERU_CONDA_ENV = os.getenv("MINERU_CONDA_ENV", "")
    MINERU_CONDA_ROOT = os.getenv("MINERU_CONDA_ROOT", "~/miniconda3")
